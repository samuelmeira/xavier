defmodule XavierWeb.Router do
  ...
  scope "/", XavierWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{XavierWeb.UserAuth, :redirect_if_user_is_authenticated}] do
  ...
  scope "/", XavierWeb do
    ...
    live_session :require_authenticated_user,
      on_mount: [{XavierWeb.UserAuth, :ensure_authenticated}] do
  ...
  scope "/", XavierWeb do
    ...
    live_session :current_user,
      on_mount: [{XavierWeb.UserAuth, :mount_current_user}] do
